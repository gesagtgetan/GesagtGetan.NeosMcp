...
- **Lazy/deferred tool loading** — Currently all 17 tool schemas are loaded into context on every turn. Claude.ai supports deferred loading for its managed MCP servers (Notion, Slack), but not for custom servers. Claude Code has open feature requests ([#3036](https://github.com/anthropics/claude-code/issues/3036), [#7336](https://github.com/anthropics/claude-code/issues/7336), [#23508](https://github.com/anthropics/claude-code/issues/23508)) for lazy tool loading; community workarounds exist (e.g. [claude-lazy-loading](https://github.com/machjesusmoto/claude-lazy-loading)). Revisit when the MCP protocol or Claude Code adds native support.
